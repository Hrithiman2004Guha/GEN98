...
def GetandDisplayResponse():
    ...
    Output_box.configure(state='disabled')
welcome_box = customtkinter.CTkLabel(master=app, text="""Welcome to GEN98, your GAC 2023 and MNNIT Information Companion!

GEN98 is your go-to chatbot for all things related to the upcoming Global Alumni Convention (GAC) in 2023 and essential general information about Motilal Nehru National Institute of Technology (MNNIT). Whether you're a curious alumnus looking for the latest GAC updates or someone interested in learning about MNNIT, I'm here to provide you with the knowledge you seek.

Feel free to inquire about the event schedule, speakers, activities, or any details regarding GAC 2023. Additionally, if you have questions about MNNIT's campus, academic programs, or student life, I've got you covered.

Just type your queries or topics of interest, and I'll ensure you receive accurate and up-to-date information. GEN98 is your virtual guide, ready to assist and inform, bridging the gap between alumni and the institution that holds a special place in your heart. Let's embark on this journey of knowledge and nostalgia together!
...
banner = tkinter.Label(side_panel, text="MNNIT ROBOTICS CLUB", font=("Comic Sans MS", 16), bg="#333333",fg="white", padx=10, pady=30)
banner.pack(fill="x")
...
Output_box = customtkinter.CTkTextbox(master = app, width = 1000,corner_radius=30,border_spacing=1,height=450,font=("Comic Sans MS",16), fg_color="#333333")
